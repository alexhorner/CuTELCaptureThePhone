...
using CutelPhoneGame.Data.Postgres.EntityConfigurations;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.ChangeTracking;

namespace CutelPhoneGame.Data.Postgres
{
    public class CutelPhoneGameDbContext : DbContext
    {
        public CutelPhoneGameDbContext() { }
        
        public CutelPhoneGameDbContext(DbContextOptions<CutelPhoneGameDbContext> options) : base(options) { }
